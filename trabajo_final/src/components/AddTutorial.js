      ...
      {submitted ? (
        ...
        <div>
          <div className="form-group">
            <label class="blanco" htmlFor="Nombre">Nombre</label>
            <input
              type="text"
          ...
          <br />
            <div className="form-group">
              <label class="blanco"  htmlFor="Apellido">Apellido</label>
              <input
                type="text"
                className="form-control"
                id="Apellido"
            ...
            <br />
            <div className="form-group">
              <label class="blanco" htmlFor="Edad">Edad</label>
              <input
                type="number"
                className="form-control"
                id="Edad"
            ...
            <br />
            <div className="form-group">
              <label class="blanco" htmlFor="Horario">Horario</label>
              <input
                type="text"
                className="form-control"
                id="Horario"
            ...
            <br />
            <div className="form-group">
              <label class="blanco" htmlFor="Clase">Clase</label>
              <input
                type="text"
                className="form-control"
                id="Clase"
